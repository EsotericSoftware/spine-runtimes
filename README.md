...
This GitHub project hosts the Spine Runtimes which are needed to use [Spine](https://esotericsoftware.com/) 2D skeletal animation data with various game toolkits.
...
It is highly suggested to [freeze](https://esotericsoftware.com/spine-settings#Version) the Spine editor version to match the Spine Runtimes source being used and to update them in lock step. See the [Spine Runtimes Guide](https://esotericsoftware.com/spine-runtime-architecture#Versioning) for more information.

## Contributing

In order to merge your contributions, we need a signed [contributor license agreement (CLA)](https://esotericsoftware.com/licenses/cla.txt) from you. You can send a copy of the CLA to contact@esotericsoftware.com.
