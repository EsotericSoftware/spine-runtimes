#ifndef SPINE_SPINE_SCALE_Y_TIMELINE_H
#define SPINE_SPINE_SCALE_Y_TIMELINE_H
...
SPINE_C_API spine_scale_y_timeline spine_scale_y_timeline_create(size_t frameCount, size_t bezierCount, int boneIndex);

SPINE_C_API void spine_scale_y_timeline_dispose(spine_scale_y_timeline self);
...
SPINE_C_API float spine_scale_y_timeline_get_relative_value(spine_scale_y_timeline self, float time, float alpha, spine_mix_from from, bool add,
															float current, float setup);
SPINE_C_API float spine_scale_y_timeline_get_absolute_value_1(spine_scale_y_timeline self, float time, float alpha, spine_mix_from from, bool add,
															  float current, float setup);
SPINE_C_API float spine_scale_y_timeline_get_absolute_value_2(spine_scale_y_timeline self, float time, float alpha, spine_mix_from from, bool add,
															  float current, float setup, float value);
SPINE_C_API float spine_scale_y_timeline_get_scale_value(spine_scale_y_timeline self, float time, float alpha, spine_mix_from from, bool add,
														 bool out, float current, float setup);
SPINE_C_API float spine_scale_y_timeline_before_first_key(spine_mix_from from, float alpha, float current, float setup);
...
#endif /* SPINE_SPINE_SCALE_Y_TIMELINE_H */
