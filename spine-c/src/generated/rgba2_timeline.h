#ifndef SPINE_SPINE_RGBA2_TIMELINE_H
#define SPINE_SPINE_RGBA2_TIMELINE_H
...
SPINE_C_API spine_rgba2_timeline spine_rgba2_timeline_create(size_t frameCount, size_t bezierCount, int slotIndex);
