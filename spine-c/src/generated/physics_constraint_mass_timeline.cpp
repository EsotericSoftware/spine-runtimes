#include "physics_constraint_mass_timeline.h"
#include <spine/spine.h>

using namespace spine;

spine_physics_constraint_mass_timeline spine_physics_constraint_mass_timeline_create(size_t frameCount, size_t bezierCount,
																					 int physicsConstraintIndex) {
	return (spine_physics_constraint_mass_timeline) new (__FILE__, __LINE__)
		PhysicsConstraintMassTimeline(frameCount, bezierCount, physicsConstraintIndex);
}

void spine_physics_constraint_mass_timeline_dispose(spine_physics_constraint_mass_timeline self) {
	delete (PhysicsConstraintMassTimeline *) self;
}

spine_rtti spine_physics_constraint_mass_timeline_get_rtti(spine_physics_constraint_mass_timeline self) {
...
float spine_physics_constraint_mass_timeline_before_first_key(spine_mix_from from, float alpha, float current, float setup) {
	return PhysicsConstraintMassTimeline::beforeFirstKey((MixFrom) from, alpha, current, setup);
}
