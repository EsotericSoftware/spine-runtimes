...
float spine_translate_y_timeline_get_relative_value(spine_translate_y_timeline self, float time, float alpha, bool fromSetup, bool add, float current,
													float setup) {
	TranslateYTimeline *_self = (TranslateYTimeline *) self;
	return _self->getRelativeValue(time, alpha, fromSetup, add, current, setup);
}

float spine_translate_y_timeline_get_absolute_value_1(spine_translate_y_timeline self, float time, float alpha, bool fromSetup, bool add,
													  float current, float setup) {
	TranslateYTimeline *_self = (TranslateYTimeline *) self;
	return _self->getAbsoluteValue(time, alpha, fromSetup, add, current, setup);
}

float spine_translate_y_timeline_get_absolute_value_2(spine_translate_y_timeline self, float time, float alpha, bool fromSetup, bool add,
													  float current, float setup, float value) {
	TranslateYTimeline *_self = (TranslateYTimeline *) self;
	return _self->getAbsoluteValue(time, alpha, fromSetup, add, current, setup, value);
}

float spine_translate_y_timeline_get_scale_value(spine_translate_y_timeline self, float time, float alpha, bool fromSetup, bool add, bool out,
												 float current, float setup) {
	TranslateYTimeline *_self = (TranslateYTimeline *) self;
