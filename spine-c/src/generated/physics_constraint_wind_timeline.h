#ifndef SPINE_SPINE_PHYSICS_CONSTRAINT_WIND_TIMELINE_H
#define SPINE_SPINE_PHYSICS_CONSTRAINT_WIND_TIMELINE_H
...
SPINE_C_API spine_physics_constraint_wind_timeline spine_physics_constraint_wind_timeline_create(size_t frameCount, size_t bezierCount,
																								 int physicsConstraintIndex);

SPINE_C_API void spine_physics_constraint_wind_timeline_dispose(spine_physics_constraint_wind_timeline self);
...
SPINE_C_API float spine_physics_constraint_wind_timeline_before_first_key(spine_mix_from from, float alpha, float current, float setup);
