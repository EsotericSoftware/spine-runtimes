#ifndef SPINE_SPINE_RGB2_TIMELINE_H
#define SPINE_SPINE_RGB2_TIMELINE_H
...
SPINE_C_API spine_rgb2_timeline spine_rgb2_timeline_create(size_t frameCount, size_t bezierCount, int slotIndex);
