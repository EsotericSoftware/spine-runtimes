...
float spine_bone_timeline1_get_relative_value(spine_bone_timeline1 self, float time, float alpha, spine_mix_from from, bool add, float current,
											  float setup) {
	BoneTimeline1 *_self = (BoneTimeline1 *) self;
	return _self->getRelativeValue(time, alpha, (MixFrom) from, add, current, setup);
}

float spine_bone_timeline1_get_absolute_value_1(spine_bone_timeline1 self, float time, float alpha, spine_mix_from from, bool add, float current,
												float setup) {
	BoneTimeline1 *_self = (BoneTimeline1 *) self;
	return _self->getAbsoluteValue(time, alpha, (MixFrom) from, add, current, setup);
}

float spine_bone_timeline1_get_absolute_value_2(spine_bone_timeline1 self, float time, float alpha, spine_mix_from from, bool add, float current,
												float setup, float value) {
	BoneTimeline1 *_self = (BoneTimeline1 *) self;
	return _self->getAbsoluteValue(time, alpha, (MixFrom) from, add, current, setup, value);
}

float spine_bone_timeline1_get_scale_value(spine_bone_timeline1 self, float time, float alpha, spine_mix_from from, bool add, bool out, float current,
										   float setup) {
	BoneTimeline1 *_self = (BoneTimeline1 *) self;
	return _self->getScaleValue(time, alpha, (MixFrom) from, add, out, current, setup);
}

float spine_bone_timeline1_before_first_key(spine_mix_from from, float alpha, float current, float setup) {
	return BoneTimeline1::beforeFirstKey((MixFrom) from, alpha, current, setup);
}
