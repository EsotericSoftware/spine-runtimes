#ifndef SPINE_SPINE_PHYSICS_CONSTRAINT_STRENGTH_TIMELINE_H
#define SPINE_SPINE_PHYSICS_CONSTRAINT_STRENGTH_TIMELINE_H
...
SPINE_C_API spine_physics_constraint_strength_timeline spine_physics_constraint_strength_timeline_create(size_t frameCount, size_t bezierCount,
																										 int physicsConstraintIndex);

SPINE_C_API void spine_physics_constraint_strength_timeline_dispose(spine_physics_constraint_strength_timeline self);
