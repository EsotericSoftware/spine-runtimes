#ifndef SPINE_SPINE_PHYSICS_CONSTRAINT_INERTIA_TIMELINE_H
#define SPINE_SPINE_PHYSICS_CONSTRAINT_INERTIA_TIMELINE_H
...
SPINE_C_API spine_physics_constraint_inertia_timeline spine_physics_constraint_inertia_timeline_create(size_t frameCount, size_t bezierCount,
																									   int physicsConstraintIndex);

SPINE_C_API void spine_physics_constraint_inertia_timeline_dispose(spine_physics_constraint_inertia_timeline self);
...
SPINE_C_API float spine_physics_constraint_inertia_timeline_before_first_key(spine_mix_from from, float alpha, float current, float setup);
...
SPINE_C_API void spine_physics_constraint_inertia_timeline_set_bezier(spine_physics_constraint_inertia_timeline self, size_t bezier, size_t frame,
																	  float value, float time1, float value1, float cx1, float cy1, float cx2,
