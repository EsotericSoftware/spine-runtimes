#ifndef SPINE_SPINE_PATH_CONSTRAINT_SPACING_TIMELINE_H
#define SPINE_SPINE_PATH_CONSTRAINT_SPACING_TIMELINE_H
...
SPINE_C_API spine_path_constraint_spacing_timeline spine_path_constraint_spacing_timeline_create(size_t frameCount, size_t bezierCount,
																								 int constraintIndex);

SPINE_C_API void spine_path_constraint_spacing_timeline_dispose(spine_path_constraint_spacing_timeline self);
