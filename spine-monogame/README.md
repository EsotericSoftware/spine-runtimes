...
The spine-monogame runtime provides functionality to load, manipulate and render [Spine](https://esotericsoftware.com) skeletal animation data using [MonoGame](https://monogame.net/). spine-monogame is based on [spine-xna](../spine-xna) and adds MonoGame project files.
