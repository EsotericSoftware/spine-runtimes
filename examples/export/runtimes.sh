...
if [ -d "$ROOT/spine-libgdx" ]; then
	...
	echo "Skipping spine-libgdx: directory not found"
fi

if [ -d "$ROOT/spine-as3" ]; then
	echo "spine-as3"
	...
	echo "Skipping spine-as3: directory not found"
fi

if [ -d "$ROOT/spine-cocos2d-objc" ]; then
	...
	echo "Skipping spine-cocos2d-objc: directory not found"
fi

if [ -d "$ROOT/spine-cocos2dx" ]; then
	echo "spine-cocos2dx"
	...
	echo "Skipping spine-cocos2dx: directory not found"
fi

if [ -d "$ROOT/spine-corona" ]; then
	echo "spine-corona"
	...
	echo "Skipping spine-corona: directory not found"
fi

if [ -d "$ROOT/spine-love" ]; then
	echo "spine-love"
	...
	echo "Skipping spine-love: directory not found"
fi

if [ -d "$ROOT/spine-sfml/c" ]; then
	echo "spine-sfml-c"
	...
	echo "Skipping spine-sfml-c: directory not found"
fi

if [ -d "$ROOT/spine-sfml/cpp" ]; then
	echo "spine-sfml-cpp"
	...
	echo "Skipping spine-sfml-cpp: directory not found"
fi

if [ -d "$ROOT/spine-starling" ]; then
	echo "spine-starling"
	...
	echo "Skipping spine-starling: directory not found"
fi

if [ -d "$ROOT/spine-ts" ]; then
	echo "spine-ts"
	...
	echo "Skipping spine-ts: directory not found"
fi

if [ -d "$ROOT/spine-xna" ]; then
	echo "spine-xna"
	...
	echo "Skipping spine-xna: directory not found"
fi

if [ -d "$ROOT/spine-unity" ]; then
	echo "spine-unity"
	...
	echo "Skipping spine-unity: directory not found"
fi
