...
The **spine-unity** runtime provides functionality to load, manipulate and render [Spine](https://esotericsoftware.com) skeletal animation data using [Unity](https://unity.com/). spine-unity is based on [spine-csharp](../spine-csharp).
...
### [Please see the spine-unity guide for full documentation](https://esotericsoftware.com/spine-unity).

1. Create an empty Unity project (or use an existing project).
2. Download and import the [`spine-unity.unitypackage`](https://esotericsoftware.com/spine-unity-download/).

See the [Spine Runtimes documentation](https://esotericsoftware.com/spine-documentation#runtimes) on how to use the APIs and check out the spine-unity examples for demonstrations of Unity specific features.
